#!/usr/bin/python
 # -*- encoding: utf-8 -*-
'''Developer by David Fernandez for Paws project
Buenos Aires 2015
Base on  http://www.bytecreation.com/blog/2013/10/13/raspberry-pi-ultrasonic-sensor-hc-sr04
'''
...
# found that the sensor can crash if there isn't a delay here
  ...
  # return the distance of an object in front of the sensor in cm
        ...
        value = str (volumen)
        redondeo = value [:4]
        campos = urllib.urlencode({"petId": "1", "waterLevel":redondeo})
